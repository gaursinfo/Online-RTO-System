...
<div id="middle">
	...
	<div id="content_left">
    	...
    	<h3>Please keep the hard copy of form and Note down registration number : <?php echo $_REQUEST['reg_no']; ?></h3>
		<div class="Hline">&nbsp;</div>
		...
		if((($_FILES["photo"]["type"] == "image/gif") ||($_FILES["photo"]["type"] == "image/jpeg") || ($_FILES["photo"]["type"] == "image/pjpeg") || ($_FILES["photo"]["type"] == "image/png")) && ($_FILES["photo"]["size"]>0))
		{
			...
			else
			{
				...
				{
					move_uploaded_file($_FILES["photo"]["tmp_name"],"photo/" . $_REQUEST['reg_no'].".jpg");
				}
			}
		}
		else
		...
		if((($_FILES["sign"]["type"] == "image/gif") ||($_FILES["sign"]["type"] == "image/jpeg") || ($_FILES["sign"]["type"] == "image/pjpeg") || ($_FILES["sign"]["type"] == "image/png")) && ($_FILES["sign"]["size"]>0))
		{
			...
			else
			{
				...
				{
					move_uploaded_file($_FILES["sign"]["tmp_name"],"sign/" . $_REQUEST['reg_no'].".jpg");
				}
			}
		}
		else
		...
		if((($_FILES["proof1"]["type"] == "image/gif") ||($_FILES["proof1"]["type"] == "image/jpeg") || ($_FILES["proof1"]["type"] == "image/pjpeg") || ($_FILES["proof1"]["type"] == "image/png")) && ($_FILES["proof1"]["size"]>0))
		{
			...
			else
			{
				...
				{
					move_uploaded_file($_FILES["proof1"]["tmp_name"],"proof1/" . $_REQUEST['reg_no'].".jpg");
				}
			}
		}
		else
		...
		if((($_FILES["proof2"]["type"] == "image/gif") ||($_FILES["proof2"]["type"] == "image/jpeg") || ($_FILES["proof2"]["type"] == "image/pjpeg") || ($_FILES["proof2"]["type"] == "image/png")) && ($_FILES["proof2"]["size"]>0))
		{
			...
			else
			{
				...
				{
					move_uploaded_file($_FILES["proof2"]["tmp_name"],"proof2/" . $_REQUEST['reg_no'].".jpg");
				}
			}
		}
		else
		...
		mysql_select_db("rto");
		$rec=mysql_query("select * from learning where reg_no=".$_REQUEST['reg_no']);
		...
		echo  "	<tr><td>Registration No.</td><td>".$row['reg_no']."</td></tr>
				...
				<tr><td>Photo</td><td><img src='photo/".$row['reg_no'].".jpg' height=200 width=200></td></tr>
				<tr><td>Signature</td><td><img src='sign/".$row['reg_no'].".jpg' height=200 width=200></td></tr>
